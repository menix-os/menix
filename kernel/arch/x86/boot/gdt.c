...
ATTR(aligned(0x10)) ATTR(section(".data")) GdtDesc			gdt_table[7] = { 0 };
ATTR(aligned(0x10)) ATTR(section(".data")) GdtRegister		gdtr = { .limit = sizeof(gdt_table), .base = gdt_table };
ATTR(aligned(0x10)) ATTR(section(".data")) TaskStateSegment tss = { 0 };
